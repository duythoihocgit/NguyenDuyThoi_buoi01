...
//Route Brand
    ...
    Route::prefix("banner")->group(function(){
     ...
     Route::prefix("oder")->group(function(){
        Route::get("/",[OderController::class,'index'])->name('admin.oder.index');
        Route::get("trash",[OderController::class,'trash'])->name('admin.oder.trash');
        Route::get("show/{id}",[OderController::class,'show'])->name('admin.oder.show');
        Route::get("create",[OderController::class,'create'])->name('admin.oder.create');
        Route::post("store",[OderController::class,'store'])->name('admin.oder.store');
        Route::get("edit/{id}",[OderController::class,'edit'])->name('admin.oder.edit');
        Route::get("update/{id}",[OderController::class,'update'])->name('admin.oder.update');
        Route::get("delete/{id}",[OderController::class,'delete'])->name('admin.oder.delete');
        Route::get("status/{id}",[OderController::class,'status'])->name('admin.oder.status');
        Route::get("restore/{id}",[OderController::class,'restore'])->name('admin.oder.restore');
        Route::get("destroy/{id}",[OderController::class,'destroy'])->name('admin.oder.destroy');
    });
//Route oderdetail
     Route::prefix("oderdetail")->group(function(){
        Route::get("/",[OderdetailController::class,'index'])->name('admin.oderdetail.index');
        Route::get("trash",[OderdetailController::class,'trash'])->name('admin.oderdetail.trash');
        Route::get("show/{id}",[OderdetailController::class,'show'])->name('admin.oderdetail.show');
        Route::get("create",[OderdetailController::class,'create'])->name('admin.oderdetail.create');
        Route::post("store",[OderdetailController::class,'store'])->name('admin.oderdetail.store');
        Route::get("edit/{id}",[OderdetailController::class,'edit'])->name('admin.oderdetail.edit');
        Route::get("update/{id}",[OderdetailController::class,'update'])->name('admin.oderdetail.update');
        Route::get("delete/{id}",[OderdetailController::class,'delete'])->name('admin.oderdetail.delete');
        Route::get("status/{id}",[OderdetailController::class,'status'])->name('admin.oderdetail.status');
        Route::get("restore/{id}",[OderdetailController::class,'restore'])->name('admin.oderdetail.restore');
        Route::get("destroy/{id}",[OderdetailController::class,'destroy'])->name('admin.oderdetail.destroy');
    });
     //  Route menu
